        ...
        <form id="form1" name="form1" method="post" action="taskparticular.jsp?count=<%=request.getParameter("count")%>">
		  ...
		  <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            <tr>
              ...
              <td width="579" colspan="3">${planinfo.planName }</td>
            </tr>
            <tr>
              <td class="tdcolor">计划描述</td>
              <td colspan="3">${planinfo.planDesc}</td>
            </tr>
            <tr>
              <td class="tdcolor">开始时间</td>
              <td width="579"><fmt:formatDate value="${planinfo.beginDate }" pattern="yyyy-MM-dd"/></td>
              <td width="20%" class="tdcolor">结束时间</td>
              <td width="50%"><p><fmt:formatDate value="${planinfo.endDate }" pattern="yyyy-MM-dd"/></p></td>
            </tr>
            <tr>
              <td class="tdcolor">所属任务</td>
              <td>${planinfo.task.taskName}</td>
              <td class="tdcolor">计划状态</td>
              <td>${planinfo.status}</td>
            </tr>
            <tr>
              <td class="tdcolor">反馈信息</td>
              <td colspan="3">${planinfo.feedbackInfo}</td>
            </tr>
          </table>
		  <p>
              <label>
