		...
		<h1>任务详细信息:</h1>
          ...
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            <tr>
              ...
              <td width="579" colspan="3">${lgtaskinfo.taskName}</td>
            </tr>
            <tr>
              <td class="tdcolor">任务描述</td>
              <td colspan="3">${lgtaskinfo.taskDesc }</td>
            </tr>
            <tr>
              <td class="tdcolor">开始时间</td>
              <td width="579"><fmt:formatDate value="${lgtaskinfo.beginDate }"  pattern="yyyy-MM-dd"/></td>
              <td width="579" class="tdcolor">结束时间</td>
              <td width="579"><p><fmt:formatDate value="${lgtaskinfo.endDate }"  pattern="yyyy-MM-dd"/></p>              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
               ${lgtaskinfo.status}
                  <select name="select">
                    <option value="undone-${lgtaskinfo.taskId}">实施中</option>
                    <option value="end-${lgtaskinfo.taskId}">已完成</option>
                  </select>              </td>
            </tr>
        </table>
		<input name="Submit" type="submit" class="menu4" value="提交" />
		  ...
		  <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <c:forEach items="${lgtask_plan}" var="g">
              ...
              <td><label>
              <c:if test="${g.isFeedback eq '是' }">
              <input type="checkbox" name="radiobutton" value="${g.planId }" />   
              </c:if>
              
              </label></td>
            </tr>
             <tr id="trfeed${g.planId }" style="display: none">
              <td colspan="6">${g.feedbackInfo}</td>
            </tr>
            </c:forEach>
          </table>
		  <p>
