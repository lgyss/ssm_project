...
public class TEmployee {
	...
	public String toString() {
		return "TEmployee [role=" + role + ", emp=" + emp + ", employeeId="
				+ employeeId + ", employeeName=" + employeeName + ", password="
				+ password + ", realName=" + realName + ", sex=" + sex
				+ ", birthday=" + birthday + ", duty=" + duty + ", enrolldate="
				+ enrolldate + ", education=" + education + ", major=" + major
				+ ", experience=" + experience + ", roleId=" + roleId
				+ ", parentId=" + parentId + "]";
	}
