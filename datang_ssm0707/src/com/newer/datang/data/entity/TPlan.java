...
public class TPlan {
	...
	public String toString() {
		return "TPlan [task=" + task + ", planId=" + planId + ", planName="
				+ planName + ", status=" + status + ", isFeedback="
				+ isFeedback + ", beginDate=" + beginDate + ", endDate="
				+ endDate + ", taskId=" + taskId + ", feedbackInfo="
